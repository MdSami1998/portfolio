...
const Projects = () => {
    ...
    return (
        <div>
            <h1 className='text-primary text-center text-3xl uppercase border-b-2 border-primary w-48 mx-auto tracking-widest my-5'>Projects</h1>
            ...
            <div>
                <h2 className='text-primary text-center text-3xl font-semibold mt-20 border-b-2 border-primary w-24 mx-auto tracking-widest'>Skills </h2>
